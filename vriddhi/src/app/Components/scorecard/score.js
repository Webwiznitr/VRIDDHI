  ...
  return (
    <>
      ...
      <div className={`bg-[rgb(24,24,33)] w-full sm:hidden`}>
        ...
        <div
          className={`w-full flex justify-evenly col-span-2 items-center text-black mt-2`}
        >
          <button
            id="cricket-btn-mob"
            onClick={() => {
        ...
        <div className={`w-full flex`}>
                ...
                <div className={`w-full flex items-center flex-col`}>
                  {upcomingSport.map((data) => {
                    return (
                      <div
                        key={data.id}
                        className={`w-[90%] mt-4 rounded-[10px] bg-[#F4F4F4] flex flex-col items-center overflow-hidden text-[10px] text-black `}
                      >
                        <div className={`w-full flex flex-col mb-2`}>
                          ...
                          <div className={`w-full flex`}>
                            <div
                              className={`w-[58%] h-full flex flex-col items-center`}
                            >
                              <div className={`w-[90%] flex`}>
                                <div className={`w-[30%] h-[18px] `}>
                                  <Image
                                    src={data.logo_1}
                                    alt=" "
                                    width={100}
          ...
          >
            ...
            >
              {/* CRICKET */}
              <div
                id="cricket-score-completed-mob"
                className={`current-com-mob`}
              >
                <div className={`w-full flex items-center flex-col`}>
      ...
      <div className={`bg-[rgb(24,24,33)] w-full hidden sm:flex flex-col`}>
        <div className={`w-full flex justify-center flex-shrink-0`}>
          <h1
            className={`text-[38px] md:text-[48px] lg:text-[56px] xl:text-[70.26px] font-normal font-nidus`}
          >
            SCORE CARD
          </h1>
        </div>
        ...
        <div className={`flex justify-center`}>
          <div className={`w-[80%] grid grid-cols-5 grid-rows-1 mb-16`}>
            ...
            <div
              className={`w-full flex flex-col items-center text-black mt-28`}
            >
              <div
                className={`w-[70%] h-[50px] bg-[#FFFCFC] flex items-center justify-center rounded-[25px] text-[24px] my-2 `}
              >
                <h1>SPORTS</h1>
              </div>
            ...
            {/* UPCOMING SECTION */}
            <div
              className={`w-full h-full col-span-2 flex flex-col items-center justify-center`}
            >
              <div
                id="color"
              ...
              >
                ...
                <div id="cricket-score-upcoming" className={`current-up`}>
                  {upcomingSport.map((data) => (
                    ...
                    >
                      <div
                        className={`w-[75%] h-48 mt-11 rounded-[15px] bg-[#F4F4F4] flex overflow-hidden  text-black`}
                      >
                        <div
                          className={`w-[66.66%] h-full flex flex-col items-center`}
                        >
