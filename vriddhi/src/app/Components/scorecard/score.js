                ...
                <div className={`w-full flex items-center flex-col`}>
                  {
                    upcomingSport.map((data)=>{
                      return(
                        <div key={data.id} className={`w-[90%] mt-4 rounded-[10px] bg-[#F4F4F4] flex flex-col items-center overflow-hidden text-[10px] text-black `}>
                            ...
                            <div className={`w-[58%] h-full flex flex-col items-center`}>
                              <div className={`w-[90%] flex`}>
                                <div className={`w-[30%] h-[18px] `}>
                                  <Image src={data.logo_1} alt=" " width={100} height={100} className="h-fit w-fit" />
                                </div>
                              ...
                              <div className={`w-[90%] flex`}>
                                <div className={`w-[30%] h-[18px] `}>
                                  <Image src={data.logo_2} alt=" " width={100} height={100}  className="h-fit w-fit" />
                                </div>
                                <div className={`w-[70%] flex items-center`}>
              ...
              <div
                ...
                {/* UPCOMING SPORTS */}
                    ...
                    <div id="cricket-score-upcoming" className={`current-up`}>
                      {
                        upcomingSport.map((data)=>(
                          <div key={data.id} className={`w-full flex items-center flex-col`}>
                  ...
                  <div className={`w-full flex items-center flex-col`}>
                    {
                      completedSport.map((data)=>{
                        return(
                          <div key={data.id} className={`w-[75%] h-52 mt-11 rounded-[15px] bg-[#F4F4F4] flex flex-col items-center overflow-hidden  text-black`}>
