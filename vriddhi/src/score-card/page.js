    ...
    return(
        <>
            ...
            <div className="bg-[rgb(24,24,33)] w-full sm:hidden">
                ...
                <div className="w-full flex">
                        ...
                        <div className="w-1/2 h-full flex flex-col items-center justify-center">
                            <div className="w-[60%] h-[24px] bg-[#001A43] rounded-[78px] mt-4 
                            flex justify-center items-center text-[10px]">
                                <h1>UPCOMING</h1>
                            </div>

                            <div id="score-card-upcoming" className="w-[90%] lg:w-[80%] h-[300px] rounded-[15px] my-4 overflow-y-scroll scrollbar">
                        ...
                        <div className="w-1/2 h-full flex flex-col items-center justify-center">
                            <div className="w-[60%] h-[24px] bg-[#F4A100] rounded-[78px] mt-4 
                            flex justify-center items-center text-[10px]">
                                <h1>COMPLETED</h1>
                            </div>

                            <div id="score-card-completed" className="w-[90%] lg:w-[80%] h-[300px] rounded-[10px] my-4  overflow-y-scroll scrollbar">
            ...
            <div className="bg-[rgb(24,24,33)] w-full hidden sm:flex flex-col">
                <div className="w-full flex justify-center flex-shrink-0">
                    <h1 className="text-[38px] md:text-[48px] lg:text-[56px] xl:text-[70.26px] font-normal">SCORE CARD</h1>
                </div>
                ...
                <div className="w-[80%] grid grid-cols-5 grid-rows-1 mb-16">
                    ...
                    {/* BUTTONS */}
                        ...
                        <div className="w-full flex flex-col items-center text-black mt-28">
                            ...
                            <button id="cricket-btn" onClick={() => {sport_selector(`cricket-btn`,`cricket-score-upcoming`,`cricket-score-completed`);}} type="button" className="pc w-[70%] h-[50px] rounded-[25px] bg-[#D8DFE1] text-[20px] my-2 scale-125">
                                CRICKET
                            </button>
                            
                            <button id="football-btn" onClick={() => {sport_selector(`football-btn`,`football-score-upcoming`,`football-score-completed`);}} type="button" className=" w-[70%] h-[50px] rounded-[25px] bg-[#D8DFE1] text-[20px] my-2">
                                FOOTBALL
                            </button>

                            <button id="basketball-btn" onClick={() => {sport_selector(`basketball-btn`,`basketball-score-upcoming`,`basketball-score-completed`);}} type="button" className=" w-[70%] h-[50px] rounded-[25px] bg-[#D8DFE1] text-[20px] my-2">
                                BASKET BALL
                            </button>

                            <button id="khokho-btn" onClick={() => {sport_selector(`khokho-btn`,`khokho-score-upcoming`,`khokho-score-completed`);}} type="button" className=" w-[70%] h-[50px] rounded-[25px] bg-[#D8DFE1] text-[20px] my-2">
                                KHOKHO
                            </button>

                            <button id="kabbadi-btn" onClick={() => {sport_selector(`kabbadi-btn`,`kabbadi-score-upcoming`,`kabbadi-score-completed`);}} type="button" className="w-[70%] h-[50px] rounded-[25px] bg-[#D8DFE1] text-[20px] my-2">
                                KABBADI
                            </button>
                        </div>
                    ...
                    {/* UPCOMING SECTION */}
                        <div className="w-full h-full col-span-2 flex flex-col items-center justify-center">
                            <div id="color" className="w-[78%] lg:w-[68%] h-[71.016] lg:h-[81.016px] bg-[#001A43] rounded-[78px] mt-11 
                            flex justify-center items-center text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] ">
                                <h1>UPCOMING</h1>
                            </div>

                            <div id="score-card-upcoming" className="w-[90%] lg:w-[80%] h-[500px] rounded-[15px] mt-11 overflow-y-scroll scrollbar">
                    ...
                    {/* COMPLETED SECTION */}
                        ...
                        <div className="w-full h-full col-span-2 flex flex-col items-center justify-center">
                            <div id="color" className="w-[78%] lg:w-[68%] h-[71.016] lg:h-[81.016px] bg-[#F4A100] rounded-[78px] mt-11 
                            flex justify-center items-center text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px]">
                                <h1>COMPLETED</h1>
                            </div>

                            <div id="score-card-completed" className="w-[90%] lg:w-[80%] h-[500px] rounded-[15px] mt-11 overflow-y-scroll scrollbar">
